...
![Audit Flow](Documents/audit-flow.png)

The compliance checklist domains:

![Check Domains](Documents/compliance_check_domains.png)
...
![Project Architecture](Documents/safetyCompliance_architecture.png)
...
1. Interactive Remediation Workflow
As outlined in the  Audit Flow, Phase 2 introduces:
- Action Item Creation: The agent will automatically generate specific tasks for each finding, assigning owners, due dates, and priority levels directly within the system.
- Officer Review Loop: A dedicated UI for safety officers to validate AI findings before they are finalized.
  
2. Enterprise Authentication (Okta Integration)
